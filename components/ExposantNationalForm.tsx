      ...
      <div className="bg-white rounded-xl p-8 md:p-12 flex flex-col gap-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 mt-2">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            >
              ...
              <option value="17000">
                Emplacement à 02 façades 17.000 DA
              </option>
              <option value="22000">
                Emplacement à 03 façades 22.000 DA
              </option>
              <option value="32000">
                Emplacement à 04 façades 32.000 DA
              </option>
            </select>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            >
              ...
              <option value="120000">
                4ème page de couverture 120.000 DA
              </option>
              <option value="100000">
                3ème page de couverture 100.000 DA
              </option>
              <option value="80000">
                2ème page de couverture 80.000 DA
              </option>
              <option value="32000">
                1/2 page intérieure couleur 32.000 DA
              </option>
            </select>
        ...
        <div className="flex flex-col gap-5 mt-2">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-black text-2xl font-bold">
              {prixStand.toLocaleString('fr-DZ')} DA
            </span>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-black text-2xl font-bold">
              {electricite.toLocaleString('fr-DZ')} DA
            </span>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-black text-2xl font-bold">
              {majoration.toLocaleString('fr-DZ')} DA
            </span>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-black text-2xl font-bold">
              {publicite.toLocaleString('fr-DZ')} DA
            </span>
          </div>
      ...
      <div className="bg-white rounded-xl p-8 md:p-12 flex flex-col gap-8">
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  >
                    {service.price.toLocaleString('fr-DZ')} DA HT /{' '}
                    {t('Événement')}
                  </span>
                </div>
        ...
        <div className="border-t border-gray-200 pt-6 flex justify-between items-center">
          ...
          <span className="text-2xl font-black text-[#0ea5e9]">
            {totalAdditionalServices.toLocaleString('fr-DZ')} DA HT
          </span>
        </div>
        ...
        <div className="w-full bg-white rounded-xl mt-6 p-8 md:p-12 flex flex-col gap-8 shadow-lg">
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="text-xl font-black text-black">
              {totalHT.toLocaleString('fr-DZ')} DA
            </span>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex flex-col items-center md:items-end">
              <span className="text-4xl font-black text-[#0ea5e9]">
                {totalTTC.toLocaleString('fr-DZ')} DA TTC
              </span>
            </div>
